...
// FIGHT SEQUENCE - fight scene. Click attack button to fight
  ...
  $('#fightBtn').on('click', function (event) {
    ...
    if (attack_type === 1) {
        ...
        $('.p_att_msg').text("Regular Attack!" + " " + user.attack(computer));

    } else if (attack_type === 2) {

        $('.p_att_msg').text("Special Attack!" + " " + user.special(computer));
    ...
    if (attack_type2 === 1) {
        ...
        $('.o_att_msg').text("Hit By A Regular Attack!" + " " + computer.attack(user));

    } else if (attack_type2 === 2) {

        $('.o_att_msg').text("Hit By A Special Attack!" + " " + computer.special(user));
